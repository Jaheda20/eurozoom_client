...
//         <>
//             <li>
//                 <NavLink to="/" className={`nav-link ${scrolled ? 'text-slate-500 font-bold' : 'text-black'}`}>
//                     Home
//                 </NavLink>
//             </li>
//             <li>
//                 <NavLink to="/about" className={`nav-link ${scrolled ? 'text-slate-500 font-bold' : 'text-black'}`}>
//                     About us
//                 </NavLink>
//             </li>
//             <li>
//                 <NavLink to="/contact" className={`nav-link ${scrolled ? 'text-slate-500 font-bold' : 'text-black'}`}>
//                     Contact us
//                 </NavLink>
//             </li>
//         </>
...
//     return (
//         <div
//             className={`navbar  top-0 left-1/2 transform -translate-x-1/2 z-10 w-full max-w-7xl bg-transparent fixed transition-colors bg-opacity-10 duration-300`}
//         >
//             <div className="navbar-start">
//                 <div className="dropdown">
//                     <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
    ...
    return (
        ...
        >
            <div className="navbar-start">
                ...
                <a className="btn btn-ghost text-4xl gap-0 text-white">
                    Euro
                    <span className="">Zoom</span>
                </a>
            </div>
