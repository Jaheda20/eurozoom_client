...
const ContactForm = () => {
    return (
        <div>
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mt-6 leading-tight text-slate-600">Connect with Our Support Team</h1>
            ...
            <div className="card w-full max-w-3xl mt-10">
                <form className="">
                    ...
                    <div className="mt-10 mb-20 flex items-end justify-end">
                        <button className="relative inline-flex items-center justify-center px-10 py-4 overflow-hidden font-semibold text-lg text-white bg-blue-800 rounded-lg group">
